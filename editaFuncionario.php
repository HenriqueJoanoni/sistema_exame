                    ...
                    <fieldset>
                        ...
                        <table cellspacing="10">
                            <tr>
                                ...
                                <td align="left"><select size="1" name="id_setor"><?php echo GetSetor($setorId) ?></select>
                                </td>
                                <td><label>Data de Demissão:</label></td>
                                <td><input type="text" name="dt_demissao" placeholder="dd/mm/aa" size="16" onkeypress="mascaraData(this)" value="<?php echo $funcionario['dt_demissao']?>"</td>
                            </tr>
                            <tr>
                                <td><label for="id_funcao">Função:</label></td>
                                <td align="left"><select size="1" name="id_funcao"><?php echo GetFuncao($funcId) ?></select>
                                </td>
                            </tr>
